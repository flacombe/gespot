...
export function scale_color(tag: string, scale: { [key: string]: any }[]): DataDrivenPropertyValueSpecification<string> {
...
export const materialColor_scale = [
  ['wood', '#815727'],
...
export const poleRadius_p: ExpressionSpecification = ['interpolate', ['linear'], ['zoom'],
  5, 0,
  14, 2,
  17, 5.5
];
...
export const indoor_p: ExpressionSpecification = any(
  ['==', get('location'), 'indoor'],
  ['==', get('tunnel'), true]
)

// Function to assign opacity to lines according to zoom
export const lineOpacity_p: ExpressionSpecification = ['interpolate', ['linear'], ['zoom'], 9, 1, 10, 0.6, 14, 0.3]
