...
const designIcons: { [key: string]: string } = {
  ...
  power_tower_E95H7: manifest['svg']['power_tower_E95H7'],
  power_tower_E95M7: manifest['svg']['power_tower_E95M7'],
  power_tower_F44: manifest['svg']['power_tower_F44'],
  power_tower_F5: manifest['svg']['power_tower_F5'],
  power_tower_G1T4: manifest['svg']['power_tower_G1T4'],
  power_tower_G4D4: manifest['svg']['power_tower_G4D4'],
  power_tower_G4B3: manifest['svg']['power_tower_G4B3'],
  power_tower_G4B5: manifest['svg']['power_tower_G4B3'],
  ...
  power_tower_T1N: manifest['svg']['power_tower_T1N'],
  power_tower_T1M: manifest['svg']['power_tower_T1M'],
