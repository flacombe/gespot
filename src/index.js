...
function init() {
  ...
  document.getElementsByTagName("header")[0].insertBefore(el('div', [
    el('div.d-inline',[warningArea_slider]),
    el('div.d-inline.pl-5',[layer_switcher.onAdd(map)])
  ], {"class":"pt-2 mr-1 float-right"}), document.getElementsByTagName("h1")[0]);
